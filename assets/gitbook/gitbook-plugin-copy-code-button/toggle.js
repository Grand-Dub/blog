require(["gitbook", "jquery"], function (gitbook, $) {
    ...
    gitbook.events.bind("page.change", function () {
        $("pre").each(function () {
            ...
            // ma modification
            $copyCodeButton.css({ "position": "absolute", "top": "0px", "right": "5px", "padding": "0px", "padding-left": "4px", "padding-right": "4px", "padding-top": "1px", "margin-top":"2px", "font-size": "1.2rem", "background-color": "lightsteelblue", "border-radius": "5px", "-moz-border-radius": "5px", "-webkit-border-radius": "5px", "border": "2px solid #CCCCCC" });
